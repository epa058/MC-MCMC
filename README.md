...
I didn't know what MCMCs were, but now I do. This project visualizes the electron orbitals of a hydrogen atom by sampling the wavefunction probability density $|\psi(x)^2|$ using Markov Chain Monte Carlo (MCMC) methods. It implements two sampling strategies:
